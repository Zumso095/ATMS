...
#include "LomSimulatedInputWidget.generated.h"
 ...
 */
UCLASS()
class COMMONUIPRESETS_API ULomSimulatedInputWidget : public UCommonUserWidget
{
	GENERATED_BODY()

public:

	ULomSimulatedInputWidget(const FObjectInitializer& ObjectInitializer);
